...
class CWDashboardVM{
    let dummyDataArr = [DashbaordResponse(imageName: "ic_dummy_pro_1", postTitle: Post(authorName: "Bill Roalling", details: " added 10 new photos in album", albumName: " \("Travel")"), postDate: "", isMoreBtnHide: true, details: "", isDetailsLblHide: true, likeCount: 104, commentCount: 0, multipleImage: ["ic_dummy_img_1"], isMultipleImageHide: true),
        ...
        DashbaordResponse(imageName: "ic_dummy_pro_1", postTitle: Post(authorName: "Bill Roalling", details: " added 5 new photos in album", albumName: " \("ABC")"), postDate: "", isMoreBtnHide: true, details: "ABC is love", isDetailsLblHide: false, likeCount: 33, commentCount: 10, multipleImage: ["ic_dummy_img_7", "ic_dummy_img_8", "ic_dummy_img_9", "ic_dummy_img_1", "ic_dummy_img_2"], isMultipleImageHide: false)]
}
